<template>
  <div class="container-card-element">
    <div v-for="row in bankCardElement" :key="row.title">
      <NuxtLink :to="`/deposit/bank-card/id/${row.id}`" class="block-card">
...
.main-wrapper.light-theme .container-card-element .block-card
{
  background: #ffffff;
}

.main-wrapper.light-theme .container-card-element .block-card .info-text h4
{
  color: #000000;
}
