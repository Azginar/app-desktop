...
.container-card .block-card .block-card-wrapper
{
  display: flex;
  height: 100%;
  align-items: center;
...
.container-card .block-card .wrapper-img
{
  width: 80px;
  height: 80px;
  display: flex;
...
.container-card .block-card .wrapper-img span
{
  font-style: normal;
  font-weight: 600;
  font-size: 36px;
...
.container-card .block-card .wrapper-img img
{
  width: 100%;
  height: auto;
  user-select: none;
...
.container-card .block-card .info-text h4
{
  font-style: normal;
  font-weight: 600;
  font-size: 18px;
...
.container-card .block-card .info-text p
{
  font-style: normal;
  font-weight: 600;
  font-size: 9px;
...
.container-card .block-card .info-text p:last-child
{
  margin-bottom: 0;
}

.container-card .block-card .info-text p span
{
  color: #989898;
}

.container-card .block-card .text-right
{
  right: 10px;
  top: 10px;
  font-style: normal;
...
.container-card .block-card .bg-transparent
{
...
.main-wrapper.light-theme .container-card .block-card
{
  background: #ffffff;
}

.main-wrapper.light-theme .container-card .block-card .info-text h4
{
  color: #000000;
}
