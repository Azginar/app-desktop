...
export const state = () => ({
      ...
      methods: [
        {
          ...
          link: '/deposit/bank-card/index'
        }
      ]
    },
    {
      titleBlock: 'Bank wire transfer',
      methods: [
        {
          title: 'Wire Transfer',
          type: 'bankSystem',
          minAmount: '100 USD',
          fee: '0%',
          avatar: 'https://tifia.com/images/new-site/payments-icon/wire-transfer.svg',
          link: '/deposit/form?method=wire-transfer'
        }
      ]
    },
    {
      titleBlock: 'Cryptocurrencies',
      methods: [
        {
          title: 'Bitcoin transfer BTC',
          type: 'bankSystem',
          minAmount: '100 USD',
          fee: '0%',
          avatar: 'https://tifia.com/images/new-site/payments-icon/bitcoin.svg',
          link: '/deposit/form?method=btc'
        }
      ]
    }
  ],
      ...
      methods: [
        {
          ...
          fee: '4 USD',
          avatar: 'https://tifia.com/images/new-site/payments-icon/mastercard.svg',
          link: '/withdrawal/bank-card/id/1'
        },
        {
          id: '2',
          title: '---- ---- ---- 3333',
          ...
          fee: '4 USD',
          avatar: 'https://tifia.com/images/new-site/payments-icon/mastercard.svg',
          link: '/withdrawal/bank-card/id/2'
        }
      ]
    },
    {
  ...
  [BANK_ACCOUNT]: ['test@test.tr', 'test@test.tr2'],
  [BANK_ACCOUNT_SELECTED]: 'test@test.tr',
  ...
  [HEAD_TABLE_BTC_TRANSFER]: [
    ...
    {
      value: 'Bitcoin purse for money transfer'
    },
    {
      value: 'Amount'
    },
  ...
  [TABLE_DEPOSIT_HISTORY]: [
    ...
    {
      id: '82179',
      date: '08:44 05-01-2019',
      account: 'ECN-6074081',
      system: 'Local Payment',
      deposit: '99 USD',
      comission: '+1 USD',
      bonus: '–',
      total: '100 USD'
  ...
  [TABLE_TRANSFER_HISTORY]: [
    {
      id: '51248',
      date: '13:32 07-01-2019',
      sourceAccount: 'CLS-6117769 (<span>- 20.00 USD</span>)',
      destinationAccount: 'CLS-6140723 (<span>+ 18.08 EUR</span>)'
    }
  ]
})
...
export const mutations = {
  ...
  [CHANGE_BANK_ACCOUNT] (state, selected) {
    state.BANK_ACCOUNT_SELECTED = selected
  },
...
export const actions = {
  ...
  [CHANGE_BANK_ACCOUNT] (vueContext, selected) {
    vueContext.commit('CHANGE_BANK_ACCOUNT', selected)
  },
