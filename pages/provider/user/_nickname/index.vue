  ...
  <HOCWithLabelAndNotifications>
    <template v-slot:page-content>
      <div class="trader-social-page">
        ...
        <menu-no-link :tabs-menu="MASSIVE_MENU_INNER">
          <template v-slot:summary>
            <trader-profile-table :avatar-trader="GET_AVATAR_TRADER_BY_NICKNAME" :table-data-public="GET_TRADER_INFO_BY_NICKNAME" />
...
.trader-social-page .trader-profile-table .copy-trader-block > div .right
{
  display: block;
}

.trader-social-page .trader-profile-table .copy-trader-block > div > div:first-child
{
  margin-right: 60px;
}

.trader-social-page .trader-profile-trader .btn-block
{
  display: none;
}

.main-wrapper.light-theme .trader-social-page h1,
.main-wrapper.light-theme .trader-social-page h5
{
  color: #989898;
}

.main-wrapper.light-theme .trader-social-page h1 span
{
  color: #000000;
}

.main-wrapper.light-theme .trader-social-page .ul-tabs-inner li a.active
{
  color: #000000 !important;
}

.main-wrapper.light-theme .trader-social-page .ul-tabs li a
{
  color: #989898 !important;
}

.main-wrapper.light-theme .trader-social-page h4
{
  border-color: #D4D4D4;
  color: #000000;
}
