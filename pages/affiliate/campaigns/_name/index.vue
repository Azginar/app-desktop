  ...
  <HOCWithLabelAndNotifications>
    <template v-slot:page-content>
      <div class="referrals-page-view">
        ...
        <h1>Affiliate campaign <span v-if="GET_CAMPAIGN_DATA_BY_SLUG">{{ GET_CAMPAIGN_DATA_BY_SLUG }}</span> <span v-if="GET_CAMPAIGN_STATUS_BY_SLUG" :class="GET_CAMPAIGN_STATUS_BY_SLUG">{{ GET_CAMPAIGN_STATUS_BY_SLUG }}</span></h1>
        ...
        <div class="block-black">
          <info-campaigns :content="GET_CAMPAIGN_INFO" />
        </div>
...
.referrals-page-view h1 span.active
{
...
.referrals-page-view h1 span.inactive
{
  font-family: Montserrat, sans-serif;
  font-style: normal;
  font-weight: 600;
...
.main-wrapper.light-theme .referrals-page-view h1 span.active
{
  background: #ffffff;
...
.main-wrapper.light-theme .referrals-page-view .setting-affiliate .selector-wrapper-black .vs__dropdown-toggle
{
  background: #F7F6FB;
  border-color: #D4D4D4;
}

.main-wrapper.light-theme .referrals-page-view .setting-affiliate .vs--open .vs__dropdown-toggle
{
  background: #EEEDF3;
}

.main-wrapper.light-theme .selector-wrapper-black .vs__selected
{
  color: #989898;
}
