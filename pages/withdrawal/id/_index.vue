  ...
  <HOCWithLabelAndNotifications>
    <template v-slot:page-content>
      <div class="finance-page finance-page-view withdrawal-card-page">
        ...
        <h1>Finance</h1>
        <sub-menu />
        <h3 v-if="GET_PARTNERS_SYSTEMS_FOR_WITHDRAWAL">
          ...
          <div class="left-parts">
            <div class="card-block-wrap">
              ...
              <div class="form-card">
                ...
                <div class="row-line">
                  <div class="col-line lower-case-select">
                    <SimpleSelectBlack
                      :options="BANK_ACCOUNT"
                      :handle-select="CHANGE_BANK_ACCOUNT"
                      :label="'Bank account'"
                      :selected="BANK_ACCOUNT_SELECTED"
                    />
                  </div>
                </div>
                <div class="row-line">
...
export default {
  ...
  mounted () {
    this[CHANGE_PARTNERS_METHODS_FOR_WITHDRAWAL](this.$route.params.index)
  }
}
</script>
<style>
...
.withdrawal-card-page .wrapper-img
{
  width: 80px;
  height: 80px;
  display: flex;
...
.withdrawal-card-page .wrapper-img span
{
  font-style: normal;
  font-weight: 600;
  font-size: 36px;
...
.withdrawal-card-page .wrapper-img img
{
  width: 100%;
  height: auto;
  user-select: none;
...
.withdrawal-card-page .lower-case-select .selector-wrapper-black .vs__selected
{
  text-transform: none;
}
...
.main-wrapper.light-theme .withdrawal-card-page .card-block-wrap .form-card .col-line .only-text p span
{
  color: #989898;
}
